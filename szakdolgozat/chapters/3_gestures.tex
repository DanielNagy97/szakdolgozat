...
A program működése során felmerülő feladatokhoz a \textit{Random Forest} típusú osztályozót választottam, amely döntési fákat alkalmaz a részminták halmazán, majd átlagolás segítségével hozza meg a döntéseket. Az egyszerre több osztályozó segítségével történő osztályozást \textit{ensemble}, vagyis együttes \cite{geron2019hands} módszereknek nevezzük.
...
\caption{Egy levegőbe leírt kör mintázata a 15$\times$11-ös vásznon}
